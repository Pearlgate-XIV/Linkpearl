...
gh release edit dev --notes "Current Linkpearl. Add https://raw.githubusercontent.com/Pearlgate-XIV/Linkpearl/main/linkpearl.json as a Dalamud custom repository."
