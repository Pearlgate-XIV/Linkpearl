...
internal static class CharacterClaimSheet
{
    public static bool Draw(in AppletFrame frame, Rect glass, IGameSession game, CharacterMigration migration)
    {
        ...
        frame.Text.DrawWrapped(body,
            "Calendar, Pearls, Phone notes, Friends, Market, and chat marks belong to one main character. You can choose that character now (the one you just logged in as). You can change it later in Settings \u2192 Profile.",
